    ...
    >
      ...
      >
        <div 
          ...
          aria-hidden="true"
        >
          <img src="/svgs/icons/CHECK.svg" alt="" role="presentation" />
        </div>
      ...
      >
        <div 
          ...
          aria-hidden="true"
        >
          <img src="/svgs/icons/DOLLAR.svg" alt="" role="presentation" />
        </div>
        <div className="trust-text">
          <span 
            className="trust-number"
      ...
      >
        <div 
          ...
          aria-hidden="true"
        >
          <img src="/svgs/icons/LIKE.svg" alt="" role="presentation" />
        </div>
        <div className="trust-text">
          <span 
            className="trust-number"
